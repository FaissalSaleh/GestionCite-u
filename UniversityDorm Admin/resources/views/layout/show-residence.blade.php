<!--================Latest Blog Area =================-->
<!-- 	<section class="latest_blog_area section_gap color-bg" id="show" style="display:none;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
	...
	<!--================End Latest Blog Area =================-->
	 <section class="blog-section spad" id="show" style="display:none;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
            	@foreach($residences as $r)
                <div class="col-lg-4">
                    <div class="blog-item set-bg up" data-setbg="files/{{$r->photo}}" style="cursor: pointer;">
                        <div class="bi-text">
                            <span class="b-tag">capacite {{$r->capacite}}</span>
                            <h4><a href="#" data-toggle="modal" data-target="#exampleModalCenter">Residence  {{$r->name}}</a></h4>
                            <div class="b-time">Description<i class="icon_clock_alt"></i> {{$r->message}}</div>
                        </div>
                    </div>
                </div>
                @endforeach
