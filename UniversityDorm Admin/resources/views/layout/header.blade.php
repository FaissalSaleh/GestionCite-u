...
<link rel="stylesheet" type="text/css" href="A.style.css%2bcss%2c%2c_custom.css%2cMcc.HvWh1qoob-.css.pagespeed.cf.pWH5huNcWh.css"/>
  ...
  <link rel="stylesheet" href="css/Radisson.css">
  ...
  <style type="text/css">
    .container-scroller{
      ...
      /*border-bottom: 1px solid #0c4a55;
      border-top: 1px solid #0c4a55;
      border-right: 1px solid #0c4a55;*/
      border-radius:1px;
...
#animationContainer {
   display: flex;
   max-width: 100%; /* Largeur maximale du bloc de code */
   overflow: auto; /* Ajoute une barre de défilement si le contenu dépasse */
   margin-left:0px;
   height: 100%;
   overflow: auto;
